...
$package_name = 'AddVerbatim';#{:
$generator = new Code::Generator::Perl(outdir => 't/tmp');
my $verbatim_text = <<'EOF';
my $foo = 42;
EOF
ok($generator
	->new_package($package_name)
	->add_verbatim($verbatim_text)
	->create(),
	"Generate $package_name.pm");
$expected = <<EOT;
package $package_name;
...
1;
EOT
ok_compare_with_file($expected, "t/tmp/$package_name.pm", $package_name);
#:}
